...
import badge from '@/public/badges/Kindness.png'
        ...
        <div className='flex flex-col justify-between items-center mb-20 w-full sm:w-[490px]'>
            ...
            <div className='flex flex-col w-full text-center mb-8'>
                ...
                <h2 className='badge-desc'>
                    Congratulations! You’ve earned another badge in your confidence journey. You’re doing amazing!
                </h2>
            </div>
        </div>
